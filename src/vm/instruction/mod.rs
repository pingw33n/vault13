...
pub(in super) mod instructions {
    ...
    pub static INSTRUCTIONS: [Instruction; enum_len!(Opcode)] = [
        ...
        i!(Greater,                     unimplemented),
        i!(GreaterEqual,                unimplemented),
        ...
        i!(Metarule,                    unimplemented),
        i!(Metarule3,                   unimplemented),
        i!(Mod,                         unimplemented),
        ...
        i!(PopFlagsExit,                unimplemented),
        i!(PopFlagsExitExtern,          unimplemented),
        i!(PopFlagsReturn,              unimplemented),
        ...
        i!(TileContainsPidObj,          unimplemented),
