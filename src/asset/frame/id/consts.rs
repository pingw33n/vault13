...
impl FrameId {
    ...
    pub const INVBOX: FrameId = FrameId::Generic(Generic(0x6000_030));
    pub const INVUPOUT: FrameId = FrameId::Generic(Generic(0x6000_031));
    pub const INVUPIN: FrameId = FrameId::Generic(Generic(0x6000_032));
    pub const INVDNOUT: FrameId = FrameId::Generic(Generic(0x6000_033));
    pub const INVDNIN: FrameId = FrameId::Generic(Generic(0x6000_034));
    pub const INVUPDS: FrameId = FrameId::Generic(Generic(0x6000_035));
    pub const INVDNDS: FrameId = FrameId::Generic(Generic(0x6000_036));
